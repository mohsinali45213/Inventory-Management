...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-header" style={{background:'linear-gradient(135deg, #1e40af 60%, #1e3a8a 100%)', color:'#fff', borderRadius:'18px', padding:'2.5rem 2rem 1.5rem 2rem', boxShadow:'0 4px 24px rgba(30,64,175,0.10)', marginBottom:'2rem', display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:'2em'}}>
        <div className="dashboard-title">
          <h1 style={{fontSize:'2.1rem', fontWeight:700, marginBottom:'.2em', letterSpacing:'-1px', color:'#fff'}}>Dashboard</h1>
          <p style={{fontSize:'1.1rem', color:'#e0e7ef', fontWeight:400}}>Welcome back! Here's what's happening with your inventory today.</p>
        </div>
        <div className="current-time" style={{textAlign:'right'}}>
          <div className="time-display" style={{color:'#e0e7ef'}}>
            {format(currentTime, "EEEE, MMMM d, yyyy")}
          </div>
          <div className="time-display time-large" style={{fontSize:'2rem', fontWeight:600, color:'#fff'}}>
