      ...
      <div className="page-fade-in">
        <div className="reports-container min-h-screen">
          <div className="p-4 md:p-6 lg:p-8 space-y-6">
            <div className="page-header" style={{background:'linear-gradient(135deg, #1e40af 60%, #1e3a8a 100%)', color:'#fff', borderRadius:'18px', padding:'2.5rem 2rem 1.5rem 2rem', boxShadow:'0 4px 24px rgba(30,64,175,0.10)', marginBottom:'2rem', display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:'2em'}}>
              <div className="page-title flex items-center gap-4" style={{minWidth:260}}>
                <div className="page-icon bg-white bg-opacity-20 backdrop-blur-sm p-3 rounded-xl">
                  <BarChart3 className="text-white" size={24} />
                </div>
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold" style={{color:'#fff'}}>Reports & Analytics</h1>
                  <p className="text-blue-100 mt-1" style={{color:'#e0e7ef'}}>Comprehensive overview of your inventory and sales data</p>
                </div>
              </div>
              <div className="reports-controls" style={{display:'flex', flexWrap:'wrap', alignItems:'center', gap:'1em', marginLeft:'auto'}}>
