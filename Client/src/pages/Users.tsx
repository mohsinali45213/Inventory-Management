...
const Users: React.FC = () => {
  ...
  return (
    <div className="page users-page">
      {/* Modern Card Header */}
      <div className="users-header-card futuristic-card" style={{marginBottom:'2rem'}}>
        <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'2em'}}>
          <div>
            <div className="users-title gradient-text" style={{fontSize:'2.1rem', fontWeight:700, marginBottom:'.2em', letterSpacing:'-1px'}}>Admin Users</div>
            <div className="users-subtitle" style={{fontSize:'1.1rem', color:'#e0e7ef', fontWeight:400}}>Manage admin accounts, permissions, and access</div>
          </div>
      ...
      {/* Controls Row */}
      <div className="users-controls" style={{display:'flex', flexWrap:'wrap', gap:'2em', alignItems:'center', marginBottom:'2em'}}>
      ...
      <div className="page-content">
        ...
        {/* Users Table Card */}
        <div className="users-table-card futuristic-card" style={{overflow:'hidden'}}>
          <table className="users-table futuristic-table" style={{fontSize:'1rem'}}>
            <thead>
              <tr style={{background:'#f3f6fa'}}>
                <th style={{padding:'1em', fontWeight:700, color:'#1e293b', textAlign:'left'}}>User</th>
                <th style={{padding:'1em', fontWeight:700, color:'#1e293b', textAlign:'left'}}>Phone</th>
                <th style={{padding:'1em', fontWeight:700, color:'#1e293b', textAlign:'left'}}>Status</th>
                <th style={{padding:'1em', fontWeight:700, color:'#1e293b', textAlign:'left'}}>Created</th>
            ...
            <tbody>
              {filteredUsers.map((user, idx) => (
                ...
                >
                  ...
                  <td style={{padding:'1em'}}>{user.phone}</td>
                  <td style={{padding:'1em'}}>
