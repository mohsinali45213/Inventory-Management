  ...
  return (
    <div className="page barcode-page">
      <div className="page-fade-in">
        <div className="page-header" style={{background:'linear-gradient(135deg, #1e40af 60%, #1e3a8a 100%)', color:'#fff', borderRadius:'18px', padding:'2.5rem 2rem 1.5rem 2rem', boxShadow:'0 4px 24px rgba(30,64,175,0.10)', marginBottom:'2rem'}}>
          <div className="page-title">
            <Printer className="page-icon" />
            <div>
              <h1 style={{color:'#fff'}}>Print Barcode</h1>
              <p style={{color:'#fff'}}>Generate and print barcode labels</p>
            </div>
          </div>
